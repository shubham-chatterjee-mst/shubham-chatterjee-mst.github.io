  ...
  <div class="topic-overview">
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture1.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture2.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture3.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
  ...
  <div class="topic-overview">
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture4.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture5.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture6.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture7.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture8.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
  ...
  <div class="topic-overview">
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture9.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture10.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture11.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture12.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture13.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
...
<!-- Module: Order Statistics and Matrix Multiplication -->
<div class="syllabus-section">
  ...
  <div class="topic-overview">
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture17.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture18.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
  ...
  <div class="topic-overview">
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture19.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture20.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture21.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture22.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
  ...
  <div class="topic-overview">
    <div class="topic-card">
      ...
      <div class="lecture-content">
          ...
          <ul>
            <li>
              <div class="reading-item">
                <span class="reading-source">CLRS: Chapter 15.1-15.2</span>
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture23.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture24.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture Slides
          </a>
        </div>
    ...
    <div class="topic-card">
      ...
      <div class="lecture-content">
        ...
        <div class="resources">
          <a href="/assets/pdf/lectures/Lecture25.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture 25 Slides
          </a>
          <a href="/assets/pdf/lectures/Lecture26.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture 26 Slides
          </a>
          <a href="/assets/pdf/lectures/Lecture27.pdf" class="slides-btn">
            <i class="fas fa-file-pdf"></i>
            Lecture 27 Slides
          </a>
        </div>
